...
public class Login extends javax.swing.JFrame {
    ...
    int xMouse, yMouse;
    //Instanciamos
    JFMenuCine jfmenucine;
    Conexion con;
    public Login() 
    {
        initComponents();
        this.setLocationRelativeTo(this);
        jfmenucine = new JFMenuCine();
        con = new Conexion();
    }
    ...
    private void initComponents() {
        ...
        logo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/cine.png"))); // NOI18N
